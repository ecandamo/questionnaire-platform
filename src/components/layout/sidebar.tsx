...
export function Sidebar({ isAdmin }: SidebarProps) {
  ...
  return (
    <aside className="flex h-full w-60 flex-col bg-sidebar border-r border-sidebar-border">
      {/* Brand */}
      <div className="flex flex-col items-center gap-1.5 px-4 py-4 border-b border-sidebar-border text-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 166.22 85.48" className="w-20 shrink-0" aria-label="API logo">
        ...
        <span className="text-xs font-medium text-sidebar-foreground tracking-wide">
